...
from app.services.aws_s3_service import get_image_from_project_s3, upload_image_to_project_s3, upload_file_to_project_document_s3
...
#         upload_file_to_project_document_s3(project_name, file)
